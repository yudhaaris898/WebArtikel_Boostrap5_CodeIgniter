 ...
 <!-- Page Header-->
        ...
        <div class="container">
            ...
            <?php echo form_open_multipart(); ?> 
                <div class="mb-3">    
                    <label>Judul</label>
                    <?php echo form_input('title', set_value('title',$blog['title']), 'class="form-control", placeholder="Masukkan judul artikel..."'); ?>
                </div>

                <div class="mb-3">    
                    <label>URL</label>
                    <?php echo form_input('url', set_value('url',$blog['url']) , 'class="form-control", placeholder="Masukkan url artikel..."'); ?>
                </div>

                <div class="mb-3"> 
                    <label>Konten</label>
                    <?php echo form_textarea('content', set_value('content',$blog['content']), 'class="form-control", placeholder="Masukkan konten artikel..."'); ?>
                </div>
